...
public class SmsMessage implements Serializable, Cloneable{
	...
	private String mobile;//短信时存手机号，设备通知时存设备号，微信通知时存卡号
	...
	private String dept_code;//机构号
	private String global_seq;//请求全局流水号
	...
	/** 消息类型 0-短信 1-设备通知 2-微信通知 3-网关验证  */
	...
	public String getString() {
		return "SmsMessage  user_id=" + user_id + ", td_code=" + td_code
				...
				+ ", msg_id=" + msg_id  +", do_times="+do_times+", msg_guid= "+msg_guid + ", msg_type=" + msg_type;
	}
	...
	public void setExtrafields(String extraStr) {
		Map<String,Object> extraFields = null;
		if(StringUtils.isBlank(extraStr)){
			extraFields = new HashMap<String, Object>();
		}else{
			extraFields = JSON.parseObject(extraStr,HashMap.class);
		}
		this.extraFields = extraFields;
	}
	...
	public Object deepClone(){
		...
		try {
			...
			result = (SmsMessage)ois.readObject();
	...
	public String toString() {
		return "SmsMessage [sn=" + sn + ", submit_sn=" + submit_sn
				...
				+ ", operator_signature=" + operator_signature + ", istest="
				+ istest + ", area_code=" + area_code + ", complete_content="
				+ complete_content + ", report_fail_desc=" + report_fail_desc
				+ ", try_times=" + try_times + ", md5_index=" + md5_index
				+ ", src_number=" + src_number + ", rpt_seq=" + rpt_seq
				+ ", do_times=" + do_times + ", is_encode=" + is_encode
				+ ", msg_guid=" + msg_guid + ", template_id=" + template_id
				+ ", province=" + province + ", city=" + city + ", msg_type=" + msg_type
				+ ",dept_code=" + dept_code + ", global_seq=" + global_seq + 
